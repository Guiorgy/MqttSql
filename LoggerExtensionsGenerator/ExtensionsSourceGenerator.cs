...
";
     ...
     * 1: log level
     */
    private const string ExtensionMethodFromat = @"{0}// public static void {1}(this Logger logger, params string[] messageBits) => logger.Log(LogLevel.{1}, messageBits);
...
{0}public static void {1}(this Logger logger, Exception exception) => logger.Log(LogLevel.{1}, exception);";
     ...
     * 4: comma separated
     */
    private const string GenericExtensionMethodFormat = @"{0}public static void {1}<{2}>(this Logger logger, {3}) {{
