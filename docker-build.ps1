...
$BASE_SDK_IMAGE_TAG_MAPPING = @{
  ...
  '10.0-resolute' = @('ubuntu-26', 'ubuntu-26-chiseled', 'ubuntu-26-chiseled-extra')
  '10.0-resolute-aot' = @('ubuntu-26-aot', 'ubuntu-26-chiseled-aot', 'ubuntu-26-chiseled-extra-aot')
  '10.0-alpine' = @('alpine')
...
$BASE_RUNTIME_IMAGE_TAG_MAPPING = @{
  ...
  '10.0-resolute' = @('ubuntu-26')
  '10.0-resolute-chiseled' = @('ubuntu-26-chiseled')
  '10.0-resolute-chiseled-extra' = @('ubuntu-26-chiseled-extra')
  '10.0-alpine' = @('alpine')
