...
{
    private static readonly string AttributeNamespace = typeof(LoggerExtensionsSourceGenerator).Namespace;
    private static readonly AssemblyName AttributeAssemblyName = typeof(LoggerExtensionsSourceGenerator).Assembly.GetName();
    private static readonly string AttributeGeneratedCodeAttribute = $@"global::System.CodeDom.Compiler.GeneratedCodeAttribute(""{AttributeAssemblyName.Name}"", ""{AttributeAssemblyName.Version}"")";

    private const string AttributeName = "LoggerExtensionsAttribute";
    private static readonly string AttributeFullName = $"{AttributeNamespace}.{AttributeName}";
    private static readonly string AttributeFileName = $"{AttributeName}.generated.cs";
    static readonly string AttributeSource = $$"""
        // <auto-generated/>
        #nullable enable

        namespace {{AttributeNamespace}}
        {
            [{{AttributeGeneratedCodeAttribute}}]
            [global::System.AttributeUsage(global::System.AttributeTargets.Class | global::System.AttributeTargets.Interface, AllowMultiple = false, Inherited = false)]
    ...
    public static TypeDeclarationTreeOrError? Transform(GeneratorAttributeSyntaxContext context, CancellationToken _)
    {
        ...
        typeDeclarationTree.TypeDeclarationAncestry[0] = typeDeclarationTree.TypeDeclarationAncestry[0].WithAttributeDeclaration(new(context.GetAttributeData(AttributeName)!));
    ...
    {
        context.RegisterPostInitializationOutput(static context => context.AddSource(AttributeFileName, SourceText.From(AttributeSource, Encoding.UTF8)));

        var captures = context.SyntaxProvider
            .ForAttributeWithMetadataName(AttributeFullName, Predicate, Transform)
