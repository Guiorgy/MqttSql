// Source: https://github.com/RaymiiOrg/cpp-command-output
#ifndef COMMAND_H
#define COMMAND_H
...
// - Changed the header extension from .h to .hpp
// - Changed the namespace from raymii to command
// - Made the buffer size into a template argument
//
